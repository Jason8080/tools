...
public enum Regex {
    ...
    // 15位身份证正则（格式校验）
    ID_CARD_15_PATTERN("^[1-9]\\d{5}\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}$"),
    // 18位身份证正则（格式校验，最后一位支持X/x）
    ID_CARD_18_PATTERN("^[1-9]\\d{5}(19|20)\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx]$"),
    // 合并15/18位的通用正则
    ID_CARD_COMMON_PATTERN(ID_CARD_15_PATTERN.regex + "|" + ID_CARD_18_PATTERN.regex),
