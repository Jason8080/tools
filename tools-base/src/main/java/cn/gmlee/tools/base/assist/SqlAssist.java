 ...
 * SQL 表名解析
 * <p>
 * 感谢原著: https://github.com/mnadeem/sql-table-name-parser
 * 原作者: Nadeem Mohammad, hcl
 * <p>
 * Ultra light, Ultra fast parser to extract table name out SQLs, supports oracle dialect SQLs as well.
 * USE: new SqlAssist(sql).tables()
 *
 * @author Jas°
 * @since 2019 -04-22
 */
public final class SqlAssist {
     ...
     * @see #accept(TableNameVisitor) #accept(TableNameVisitor)#accept(TableNameVisitor)
     */
    public Collection<String> tables() {
        Map<String, String> tableMap = new HashMap(1);
        accept(token -> {
